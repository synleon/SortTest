...
import com.examples.leon.sort.Insertion;
...
public class TestInsertion{
    ...
    public void testBubble(){
        Insertion.sort( copy1, copy1.length);
        assertArrayEquals( AllTests.array1[1], copy1);
        Insertion.sort( copy2, copy2.length);
        assertArrayEquals( AllTests.array2[1], copy2);
        Insertion.sort( copy3, copy3.length);
        assertArrayEquals( AllTests.array3[1], copy3);
        Insertion.sort( copy4, copy4.length);
